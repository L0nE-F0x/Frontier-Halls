...
export const meta: HallSpec = {
  ...
  facts: [
    ...
    { label: "In the hall", value: "Muse Spark, Muse Glimmer, Llama 4" },
  ...
  people: [
    {
      ...
      why: "Muse Spark 1.3 is Meta's closed frontier model. The bench is inside work: capable, and not walked out the door.",
    ...
    },
    {
      ...
      why: "Glimmer is a smaller open-weight agent. The door is a real exit, and Glimmer is sized to use it.",
    ...
    },
    {
      ...
      why: "Llama 4 is the open-weight line, Maverick and Scout among it. The figure holds the threshold so the way out stays open.",
