...
export const deepmind: HallSpec = {
  ...
  facts: [
    ...
    { label: "In the hall", value: "Gemini 3.1 Pro, 3.8 Flash, Robotics" },
  ...
  people: [
    {
      ...
      why: "Pro is the slower pass on a hard problem. The board stays under the lamp until the reading is finished.",
    ...
    },
    {
      ...
      why: "3.8 Flash is the current model for long agent work. The racks are the experiment, and Flash is the one walking them.",
    ...
    },
    {
      ...
      why: "Robotics is the lab's bet that a model should be able to act in the world. The arm is that bet, at the scale of a bench.",
