...
export const ai2: HallSpec = {
  ...
  facts: [
    ...
    { label: "In the hall", value: "OLMo, Molmo, Tulu" },
  ],
  accent: CYAN,
  ...
  people: [
    {
      ...
      why: "OLMo is why this hall exists. The weights are public, and so is the trail of how they were trained. It does not wander off and leave the notes.",
    ...
    },
    {
      ...
      why: "Molmo is the vision line. It is the one in this room that actually needs a view, so it ends up at the front more than the others.",
