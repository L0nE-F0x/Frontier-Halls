...
export const kimi: HallSpec = {
  ...
  facts: [
    ...
    { label: "In the hall", value: "K3, K2, the coder" },
  ...
  people: [
    {
      ...
      why: "K3 is the top of the line, large enough that the hall keeps it at the bench instead of walking it around the block. The long jobs start here.",
    ...
    },
    {
      ...
      why: "K2 is the model that made a hall necessary. The newer flagship has the bench. K2 still knows which rack is which, and it is the one that drifts.",
