...
export const openai: HallSpec = {
  ...
  facts: [
    ...
    { label: "In the hall", value: "Sol, Terra, Luna" },
  ...
  people: [
    {
      id: "sol",
      name: "Sol",
      role: "GPT-5.6 flagship",
      tier: "Flagship",
      doing: "Stays at the lamp with one long problem.",
      why: "Sol is the flagship of the GPT-5.6 family. The hall's deep work is gathered in the one warm pool of light.",
    ...
    },
    {
      ...
      why: "Terra is the balanced tier for ordinary work, so Terra is the one keeping the rows in order.",
    ...
    },
    {
      ...
      why: "Luna is the fast, inexpensive tier. The short jobs move with Luna.",
