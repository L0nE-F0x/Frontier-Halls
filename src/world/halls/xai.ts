...
export const xai: HallSpec = {
  ...
  people: [
    ...
    },
    {
      ...
      why: "{short} is the hall's speech model: conversation, transcription, and a spoken answer. Talking has its own station.",
    ...
    },
    {
      ...
      why: "{short} is the image and video model. The frame is where that work stands, apart from the text bench.",
